...
import 'kleur/colors';
import { H as Header } from '../../chunks/Header_f_8O8zLJ.mjs';
...
const $$id = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="th"> ${maybeRenderHead()}<body> ${renderComponent($$result, "Header", Header, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Projects/Astro/test01/po-app/src/components/po/Header", "client:component-export": "default" })} ${renderComponent($$result, "OrderDetailPage", OrderDetailPage, { "client:load": true, "orderId": id, "client:component-hydration": "load", "client:component-path": "C:/Projects/Astro/test01/po-app/src/components/po/OrderDetailPage", "client:component-export": "default" })} </body></html>`;
}, "C:/Projects/Astro/test01/po-app/src/pages/orders/[id].astro", void 0);

const $$file = "C:/Projects/Astro/test01/po-app/src/pages/orders/[id].astro";
const $$url = "/orders/[id]";
